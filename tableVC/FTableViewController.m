...
- (void)viewDidLoad {
   ...
   MJRefreshStateHeader * header = [MJRefreshStateHeader headerWithRefreshingTarget:self refreshingAction:@selector(clickHeader)];
    //header.lastUpdatedTimeLabel.hidden = YES;//可以去掉刷新时间
    self.tableView.mj_header = header;
    
    MJRefreshBackFooter *footer = [MJRefreshBackFooter footerWithRefreshingTarget:self refreshingAction:@selector(clickFooter)];
